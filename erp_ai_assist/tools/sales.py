...
def get_customer_sales_history(customer: str, period: str = "this_year") -> dict:
    ...
    Args:
        customer: Customer name (partial match supported).
        period: Named: today, yesterday, this_week, last_week, this_month, last_month, this_year. Rolling window: last_N_days (e.g. last_7_days, last_14_days, last_90_days). Explicit range: YYYY-MM-DD:YYYY-MM-DD. Defaults to this_year.
    """
    start, end = get_date_range(period)
